...
//回调方法
@protocol NlsSpeechTranscriberwithRecorderDelegate <NSObject>
/**
 * @brief 错误回调函数
...
@interface NlsSpeechTranscriberRequestwithRecorder: NSObject
@property(nonatomic,weak) id<NlsSpeechTranscriberwithRecorderDelegate> delegate;
